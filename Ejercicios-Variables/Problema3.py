...
que saldrán en cada paquete a demanda. Cada payaso pesa 112 g y
...
numero_payasos = int(input("Digite el numero de payasos vendidos: "))
numero_muñecas = int(input("Digite el numero de muñecas vendidas: "))

peso_total = (numero_payasos*112) + (numero_muñecas*75)
